...
namespace TelegramBot.TextCommands
{
  public class TextToSpeechCommand: ITextCommand
  {
    ...
    public TextToSpeechCommand(IBotService botService)
    {
    ...
    public async Task ProcessMessage(Message message)
    {
      ...
      var language = "en-us";
      var result = message.Text.Replace(" ", "%20").Replace(",", "%2C").Substring(7).Trim();
      ...
      await _botService.Client.SendAudioAsync(message.Chat.Id, new InputOnlineFile(new MemoryStream(response.RawBytes)));
    }
  }
}
